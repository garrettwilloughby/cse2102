    ...
    <div class="login">
      <div class = "loginContainer">
        <div class = "usernameDiv">
          <input ref = "username" name = "username" class = "username" placeholder="username">
        </div>
        <div class = "passwordDiv">
          <input ref = "password" name = "password" type = "password" class = "password" placeholder="password">
        </div>
          ...
          async fetchData(username, password){
            ...
            //pass username to API *make sure querystrings configured on APIgateway
              ...
              if (response.ok) {
                ...
                const realUsername = body.Items[0].username.S;
                ...
                const credits = body.Items[0].currentCredits.N
                const totalCredits = body.Items[0].totalCredits.N
                ...
                //set login params for local storage <3
                this.loginParams = {
                    username: username,
                    password: password,
                    courses: userCourses,
